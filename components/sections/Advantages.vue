...
.advantages {
  ...
  &__card {
    ...
    &:hover {
      background-color: rgba($card-bg, 0.18);
    }
  ...
  &__device {
    ...
    &--desktop {
      ...
      box-shadow: inset 0 0 20px rgba($color-accent, 0.03);
  ...
  &__card--adaptive:hover &__device {
    border-color: rgba($color-accent, 0.65);

    &--desktop {
      box-shadow: 0 0 20px rgba($color-accent, 0.08);
    }
  }
}
</style>